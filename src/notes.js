/*
* This file contains a number of random topics that were explored during development */
import { changeHandlers } from "./onStateChange";
import { cancel, pause, resume, speak } from "./actions";
import onStateChange from "./onStateChange";
import { IDLE, PAUSED, PLAYING, PROCESSING } from "./handleStateChange";

/*Manual testing and giggering*/
console.clear();
...
/*Modeling how this sort of thing would work if it were a react component */
